...
var releaseFolder = "./build/";
// Папка, где находятся public файлы
var releasePublicFolderName = "static";
// index.html
 ...
 * */
gulp.task("build:release", ["build-css", "build-js", "build-public", "build-version", "clean-cache"]);

gulp.task("webpack-dev-server", ["clean-build", "clean-release", "clean-cache"], function(callback) {
