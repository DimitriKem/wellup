            ...
            <svg width="17px" height="18px" {...this.props} viewBox="0 0 17 18">
                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g className="svg-for-stroke" stroke="#333333" strokeWidth="2">
                            <use  mask="url(#bell-icon-path-mask-2)" xlinkHref="#bell-icon-path-closed-1" transform="translate(8.358757, 8.358757) rotate(-315.000000) translate(-8.358757, -8.358757) "></use>
